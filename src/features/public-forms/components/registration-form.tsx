...
import { submitRegistration } from '@/features/public-forms/actions/registration-actions';
...
export function RegistrationForm() {
  ...
  const form = useForm<RegistrationFormData>({
    resolver: zodResolver(registrationFormSchema as never) as Resolver<RegistrationFormData>,
    defaultValues: {
      applicantId: '',
      legalName: '',
      email: '',

...
import { submitInterviewApplication } from '@/features/public-forms/actions/interview-application-actions';
...
export function InterviewApplicationForm({ dioceses, programmes }: Props) {
  ...
  const form = useForm<InterviewApplicationFormData>({
    resolver: zodResolver(interviewApplicationFormSchema as never) as Resolver<InterviewApplicationFormData>,
    defaultValues: {
      applicantId: '',
      legalName: '',
      preferredName: '',

...
import { interviewApplicationFormSchema } from '@/features/public-forms/validations/interview-application-form';
...
import type { BAPStageStatus, Prisma } from '@/generated/prisma/client';
  ...
  try {
    ...
    if (matchResult.confidence === 'HIGH' && matchResult.match) {
      ...
      await prisma.bAPStatus.upsert({
        where: { applicantId: applicantInternalId },
        update: {
          stageOneStatus: data.bapStageOneStatus as BAPStageStatus,

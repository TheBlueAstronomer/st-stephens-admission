import { getAccommodationReport, type ReportFilterParams } from '@/lib/queries/reports';
...
import { AccommodationReportCharts } from '@/components/reports/accommodation-report-charts';

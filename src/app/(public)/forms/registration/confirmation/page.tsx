...
export const metadata = {
  title: "Registration Received \u2014 St Stephen\u2019s House",
};
    ...
    <div className="min-h-dvh bg-white">
      ...
      <main className="mx-auto max-w-160 px-4 py-16 text-center">
        ...
        <p className="text-base text-muted-foreground mb-2">
          Thank you{name ? `, ${name}` : ''}! Your registration form has been successfully
          submitted.
        </p>
        ...
        <div className="mt-8 rounded-lg border border-gray-100 bg-gray-50 p-6 text-left">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex gap-2">
              ...
              The admissions team will verify your registration details.
            </li>
            <li className="flex gap-2">
              <span className="font-medium text-foreground">2.</span>
              You will receive confirmation of your accommodation arrangements.
            </li>
            <li className="flex gap-2">
              <span className="font-medium text-foreground">3.</span>
              Welcome materials will be sent before the start of term.
            </li>
          </ul>
        </div>

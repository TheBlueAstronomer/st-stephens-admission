...
describe('F08 US-10: Audit Log Immutability', () => {
  it('audit log query module has no update or delete exports', async () => {
    const auditLogModule = await import('@/lib/queries/audit-log');
  ...
  it('no server action file exposes audit log mutations', async () => {
    const adminModules = [
      '@/app/(staff)/admin/users/actions',
      '@/app/(staff)/admin/programmes/actions',
      '@/app/(staff)/admin/dioceses/actions',
      '@/app/(staff)/admin/document-types/actions',
      '@/app/(staff)/admin/admissions-years/actions',
    ];
